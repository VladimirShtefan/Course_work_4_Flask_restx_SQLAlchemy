...
class Movie(db.Model):
    ...
    trailer = db.Column(db.String(200), unique=True)
...
movie_model = api.model(
    'Movie',
    {
        ...
        'description': fields.String(max_length=1000, example='Описание фильма'),
        'trailer': fields.String(max_length=200, example='https://film_url.ru'),
