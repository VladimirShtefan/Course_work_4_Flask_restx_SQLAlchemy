...
def test_get_one_director_success(director_dao, create_models):
    ...
    assert _director.name == 'test_director_1'
...
def test_get_all_director(director_dao, create_models):
    director = create_models(name_model=director_dao.__model__, number_of_models=2, name='test_director')
...
def test_add_director_success(director_dao, create_models):
    create_models(name_model=director_dao.__model__, number_of_models=2, name='test_director')
    ...
    assert new_director.name == 'test_director_3'
...
def test_put_director_success(director_dao, create_models, database):
    create_models(name_model=director_dao.__model__, number_of_models=1, name='test_director')
    ...
    assert new_director.name == 'put_test_director'
