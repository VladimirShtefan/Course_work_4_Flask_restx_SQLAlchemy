...
def test_get_one_genre_success(genre_dao, create_models):
    genre = create_models(name_model=Genre, number_of_models=1, name='test_genre')
    _genre = genre_dao.get_one_by_id(genre[0].id)
    assert _genre.id == 1
    assert _genre.name == 'test_genre_1'
...
def test_get_all_genres(genre_dao, create_models):
    genre = create_models(name_model=Genre, number_of_models=2, name='test_genre')
